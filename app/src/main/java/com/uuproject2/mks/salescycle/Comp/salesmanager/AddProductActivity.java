...
public class AddProductActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view == buttonChoose) {
           ...
           Intent intent=new Intent(AddProductActivity.this,ShowProductActivity.class);
            ...
            sRef.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Product upload = new Product(uploadId,editTextName.getText().toString().trim(),etQuantity.getText().toString().trim(),etPrice.getText().toString().trim(), taskSnapshot.getDownloadUrl().toString());
