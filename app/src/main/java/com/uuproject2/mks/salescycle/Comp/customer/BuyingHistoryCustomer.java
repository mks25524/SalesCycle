...
public class BuyingHistoryCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buying_history_customer);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewTouchListener(getApplicationContext(), recyclerView, new RecyclerViewClickListener() {
            ...
            public void onClick(View view, final int position) {
                ...
                final AlertDialog.Builder builder=new AlertDialog.Builder(BuyingHistoryCustomer.this);
...
//                }
            ...
            public void onLongClick(View view, final int position) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(BuyingHistoryCustomer.this);
                LayoutInflater layoutInflater=getLayoutInflater();
                final View dialogView=layoutInflater.inflate(R.layout.dialog_deleverstatus_customer,null);
                builder.setView(dialogView);
...
//                });
        ...
        DatabaseReference mDatabase1=mDatabase.child("newSalesCustomer").child(id);
        ...
        ValueEventListener valueEventListener=new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new BuyingHistoryAdapterForCustomer(getApplicationContext(), uploads);
//
